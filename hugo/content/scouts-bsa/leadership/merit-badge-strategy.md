---
title: "Strategic Merit Badge Roadmap: Eagle-Required Progression & Long-Term Planning"
description: "The strategic blueprint to earning all 21 merit badges for Eagle Scout: Managing the 4 'Time-Lock' badges (90+ day trackers), choosing between option groups, Blue Card workflows, and rank-by-rank pacing."
---

To achieve the rank of Eagle Scout, a Scout must earn a minimum of **21 merit badges**, including **14 specific Eagle-required badges** and **7 elective badges**.
...
| Category / Badge | Core Subject | Primary Completion Venue | Key Challenges |
| :--- | :--- | :--- | :--- |
| **First Aid** | Wilderness & urban trauma response | Troop meeting series or clinic | High-skill hands-on CPR and splinting. |
| **Citizenship in Society** | Inclusion, ethical leadership, civil dialogue | Facilitated small-group discussion | Guided reflection and case study analysis. |
| **Citizenship in the Community**| Local municipal government & civic service | Independent research & council meeting | Attending a public city/town council meeting. |
| **Citizenship in the Nation** | Federal government, Constitution, landmarks | School civics alignment or summer camp | Touring a federal facility or historic landmark. |
| **Citizenship in the World** | International law, foreign relations, treaties | Merit badge college or online clinic | Analyzing international treaties and global trade. |
| **Communication** | Public speaking, interviewing, writing | Troop leadership or school speech class | Giving a 5-minute speech and organizing a court of honor. |
| **Cooking** | Nutrition, camp stoves, Dutch ovens, home meal prep | Troop campouts + home kitchen | Cooking 10 meals across camp, trail, and home. |
| **Camping** | Wilderness camping, cold-weather prep, leave no trace | Troop campout program (2+ years) | Logging 20 days and 20 nights in tents. |
| **Personal Fitness** *(Time-Lock)* | Physical conditioning & health tracking | Self-paced with coach or counselor | **12-week comprehensive physical fitness program.** |
| **Family Life** *(Time-Lock)* | Family dynamics, home duties, parenting roles | Home environment | **90-day daily chore tracking + family meetings.** |
| **Personal Management** *(Time-Lock)*| Budgeting, finance, project management | Self-paced with counselor | **13-week detailed income/expense tracking.** |
| **Choice 1**: Emerg. Prep *OR* Lifesaving | Disaster response or aquatic rescue | Troop clinic or Summer Camp | Lifesaving requires strong swimming stamina. |
| **Choice 2**: Env. Science *OR* Sustainability | Ecology experiments or resource conservation | Summer Camp or home research | Env Sci requires multi-day field observations. |
| **Choice 3**: Swimming *OR* Hiking *OR* Cycling | Physical endurance & outdoor travel | Summer camp or weekend treks | Hiking requires a 20-mile hike; Cycling requires 50 miles. |
...
| Merit Badge | Eagle-Req? | Counselor Name | Blue Card Issued Date | Prerequisites / Logs Started | Target Completion Date | Status |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **First Aid** | Yes | Mr. Davis | Oct 12, 2024 | Completed First Class Aid | Nov 30, 2024 | **Completed** |
| **Swimming** | Yes | Camp Aquatics Dir | Jul 15, 2024 | Passed BSA Swimmer Test | Jul 20, 2024 | **Completed** |
| **Camping** | Yes | Mrs. Jenkins | Jan 10, 2024 | 16/20 nights logged | Oct 15, 2025 | In Progress (80%) |
| **Personal Mgmt**| Yes | Mr. Vance | Feb 01, 2025 | Week 4/13 budget log | May 30, 2025 | In Progress (30%) |
| **Family Life** | Yes | Dr. Walker | Feb 01, 2025 | Day 25/90 chore log | Jun 01, 2025 | In Progress (28%) |
...
- [ ] Verify that all 20 campout nights are recorded for the Camping merit badge.
- [ ] Identify which option badges you will pursue (Lifesaving vs Emerg Prep; Env Sci vs Sustainability; Swimming vs Hiking vs Cycling).
- [ ] Secure a Scoutmaster signed Blue Card before contacting any new Merit Badge Counselor.
- [ ] Establish a 13-week budget spreadsheet for Personal Management.
- [ ] Create and post a 90-day chore chart for Family Life.
- [ ] Schedule your baseline physical fitness test with your Personal Fitness counselor.
- [ ] Register for summer camp merit badge sessions that require camp facilities (aquatics, shooting sports, ecology).
- [ ] File all signed "Applicant" and "Counselor" Blue Card stubs in a plastic sheet protector binder.
{{< /drg/checklist >}}

---

## Related Advancement Toolkits

- [Eagle Scout Service Project Workbook & Leadership Guide](/scouts-bsa/leadership/eagle-project-workbook/)
- [Patrol Leader Field Guide: Duty Rosters & Menu Planning](/scouts-bsa/leadership/patrol-method/)
