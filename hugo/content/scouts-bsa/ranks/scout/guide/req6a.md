...
1. Sit down with your parent or guardian in a quiet setting.
2. Read the pamphlet sections and complete the interactive discussion prompts together.
3. Have your parent or guardian sign and date the verification line in your handbook once finished.

{{< drg/safety-first >}}
Scouting enforces strict **Youth Protection Policies**: all meetings and outings require at least **two registered adult leaders present (Two-Deep Leadership)**, and one-on-one contact between an adult leader and a youth member (online or in person) is strictly prohibited.
{{< /drg/safety-first >}}
