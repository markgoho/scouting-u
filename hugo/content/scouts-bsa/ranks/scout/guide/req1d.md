...
next: "/scouts-bsa/ranks/scout/guide/req1e/"
next_title: "Repeat Outdoor Code"
---

{{< drg/requirement number="1d" text_format="html" >}}
...
Even before earning the First Class rank, every Scout in Scouts BSA wears the First Class emblem on their uniform hat, belt buckle, and council shoulder strips. The First Class badge is the universal symbol of the Scouting movement in the United States, carefully designed with rich historical symbolism in every element.

## The Parts of the First Class Badge and Their Meanings
...
The First Class badge tells the story of your advancement path:
- The **Scout Rank** badge is the simple trefoil outline.
- The **Tenderfoot Rank** badge adds the eagle and shield, plus the two stars.
- The **Second Class Rank** badge is the scroll, motto, and Good Turn knot.
- The **First Class Rank** badge unites all these pieces together into one complete emblem, symbolizing a fully rounded, capable outdoor leader.

{{< drg/tip >}}
When presenting this requirement to your Scoutmaster, point to each part of the badge in sequence: the three points of the trefoil, the two stars, the eagle and shield, the smiling scroll, and the hanging knot.
{{< /drg/tip >}}
