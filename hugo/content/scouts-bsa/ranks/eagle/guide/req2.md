...
req_number: "2"
prev: "/scouts-bsa/ranks/eagle/guide/req1/"
prev_title: "Be active 6 months"
next: "/scouts-bsa/ranks/eagle/guide/req3/"
next_title: "Earn 21 merit badges"
---

{{< drg/requirement number="2" text_format="html" >}}
...
1. **Parents / Guardians**: Your parent(s) or legal guardian(s).
2. **Religious Reference**: Your religious leader (pastor, priest, rabbi, imam, bishop, youth minister). *(Note: If you are not affiliated with an organized religious institution, your parent or guardian provides this reference, attesting to your spiritual values and Duty to God).*
3. **Educational Reference**: A teacher, principal, guidance counselor, academic advisor, or homeschool instructor.
4. **Employer Reference**: Your current or recent supervisor, manager, or employer *(required only if you are currently employed)*.
5. **Two Other References**: Adult leaders, family friends, neighbors, coaches, mentors, or community leaders who have known you well over time.
...
- **Provide Ample Lead Time**: Ensure your references are informed of your application submission timeline so they are not surprised when contacted by your unit or district advancement committee.

{{< drg/checklist title="References Preparation Checklist" subtitle="Ensure all six reference slots are verified" >}}
- Parent or guardian contact details confirmed.
- Religious leader (or parent attestation) confirmed.
- Educational reference (teacher, principal, counselor) confirmed.
- Employer reference confirmed (or marked "N/A - Not Employed").
- Two additional character references confirmed.
- All names, mailing addresses, emails, and phone numbers typed accurately on the Eagle application.
{{< /drg/checklist >}}

{{< drg/tip >}}
Type your Eagle Scout Rank Application using the fillable PDF form available from Scouting America. A neatly typed application avoids transcription errors in names, dates, and contact information.
{{< /drg/tip >}}
