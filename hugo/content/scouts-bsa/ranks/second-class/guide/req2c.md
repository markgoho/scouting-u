...
next: "/scouts-bsa/ranks/second-class/guide/req2d/"
next_title: "Set up camp stove"
---

{{< drg/requirement number="2c" text_format="html" >}}
Using a minimum-impact method at an approved outdoor location and time, use the tinder, kindling, and fuel wood from Second Class requirement 2b to demonstrate how to build a fire. Unless prohibited by local fire restrictions, light the fire. After allowing the flames to burn safely for at least two minutes, safely extinguish the flames with minimal impact to the fire site. Properly dispose of the ashes and any charred remains.
{{< /drg/requirement >}}

Building, managing, and completely extinguishing a campfire is one of the most fundamental outdoor skills in Scouting. A responsible Scout never starts a fire without having safety tools ready, and never leaves a fire until it passes the strict "Cold Out" test.

## Preparing a Safe Fire Site

1. **Check Local Fire Bans:** Always confirm with rangers or camp leadership that open fires are permitted.
2. **Use Existing Fire Rings or Fire Pans:** Reusing existing rings prevents scarring new soil. If building a minimum-impact backcountry fire, build a **mound fire** (layering 3–5 inches of mineral soil onto a ground cloth) or use an elevated fire pan.
3. **Clear the 10-Foot Safety Perimeter:** Rake away all dry leaves, pine needles, grass, and twigs for a 10-foot radius around the fire ring down to bare soil.
...
A fire is not extinguished when the visible flames disappear. Deep, buried coals can stay hot for days and ignite brush hours after you leave. Follow the **Drown, Stir, Drown, Feel** method:

```
1. DROWN
   Pour water across the entire fire bed to knock down all flames and embers.
      ↓
2. STIR
   Use a stick or camp shovel to turn over logs and scrape ash clumps apart.
      ↓
3. DROWN AGAIN
   Pour more water over the stirred coals until all hissing and steam stops.
      ↓
4. FEEL (Cold Out Test)
   Hold the back of your bare hand directly over (and gently touch) all wet ashes.
   If ANY part feels warm, repeat steps 1–3 until completely cold to the touch.
```

## Ash Disposal & Site Cleanup

- **Frontcountry Campgrounds:** Leave the wet, cold ashes in the designated metal fire ring, or shovel them into a campground-provided metal ash disposal barrel.
- **Backcountry / Leave No Trace:** Once cold, crush remaining charcoal chunks into fine powder, scatter the cold ashes widely across a broad, vegetated area far from camp, and return mineral soil from mound fires to its original spot, leaving the ground pristine.

{{< drg/safety-first >}}
Never bury hot coals with dirt without water. Dirt traps heat like an insulated oven, allowing buried embers to smolder undetected and travel along tree roots to start wildland fires days later.
{{< /drg/safety-first >}}
