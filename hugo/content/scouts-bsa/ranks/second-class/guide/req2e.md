---
title: "Plan and cook a meal"
layout: "guide"
rank_slug: "second-class"
group_title: "Requirement 2"
req_number: "2e"
prev: "/scouts-bsa/ranks/second-class/guide/req2d/"
prev_title: "Set up camp stove"
next: "/scouts-bsa/ranks/second-class/guide/req2f/"
next_title: "Demonstrate sheet bend knot"
---
...
Cooking a balanced, nutritious hot meal in the field requires thoughtful planning, proper food storage, and strict kitchen hygiene. This requirement walks you through planning, packing, storing, and cooking a complete hot breakfast or hot lunch using the USDA MyPlate nutritional model.
...
3. **Vegetables:** Provide vital micronutrients, electrolytes, and fiber (peppers, onions, spinach, carrots).
4. **Fruits:** Deliver quick-burning natural sugars and vitamin C (apples, bananas, oranges, berries, dried raisins).
5. **Dairy:** Delivers calcium and vitamin D (milk, yogurt, cheddar cheese).

### Sample Balanced Camp Meals
...
- **Pack in Reverse Order:** Put foods you need last at the bottom. Keep raw meats sealed in double zip-top bags at the very bottom of the cooler directly next to the ice blocks so raw juices can never drip onto vegetables or ready-to-eat food.
...
{{< drg/safety-first >}}
Discard any perishable food (meat, dairy, opened mayonnaise) that has remained in the danger zone (above 40°F) for more than two hours.
{{< /drg/safety-first >}}
